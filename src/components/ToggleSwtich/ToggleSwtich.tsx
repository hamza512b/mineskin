  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <Switch.Root
        ...
        disabled={disabled}
      >
        <Switch.Thumb className="block w-5 h-5 bg-white rounded-full shadow-lg transition-transform duration-100 translate-x-0.5 will-change-transform data-[state=checked]:translate-x-[18px] hover:bg-slate-50" />
      </Switch.Root>
    </div>
  );
}
